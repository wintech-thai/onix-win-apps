...
{
    public class CPromotionProcessorTrayBonus : CPromotionProcessor
    {
        private Hashtable combinedHash = new Hashtable();
        private CProcessingResult res = null;
        private int minumConfigQty = 999999999;

        public CPromotionProcessorTrayBonus(MBaseModel pkg, String grpName, MBaseModel bill) : 
        ...
        */
        ...
        private CBasketSet finalizeOutput(CBasketSet input, CBasket trackingBasket, CBasket used, CBasket free)
        {
            ...
            output.AddBasket(finalizeBasket(used, BasketTypeEnum.UsedTray));
            output.AddBasket(finalizeBasket(free, BasketTypeEnum.FreeAnnonymousTray));
