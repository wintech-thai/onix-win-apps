...
{
    public class MPackageBundle : MBaseModel
    {
        ...
        public MPackageBundle(CTable obj) : base(obj)
        {
        }
        ...
        public String PackageBundleID
        {
            get
            {
                ...
                return (GetDbObject().GetFieldValue("PACKAGE_BUNDLE_ID"));
            }

            set
            {
                GetDbObject().SetFieldValue("PACKAGE_BUNDLE_ID", value);
            }
        }
