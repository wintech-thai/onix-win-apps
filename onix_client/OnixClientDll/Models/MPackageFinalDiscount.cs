...
{
    public class MPackageFinalDiscount : MBaseModel
    {
        ...
        public MPackageFinalDiscount(CTable obj) : base(obj)
        {
        }
        ...
        public String PackageFinalDiscountID
        {
            get
            {
                if (GetDbObject() == null)
                ...
                return (GetDbObject().GetFieldValue("PACKAGE_FNLDISC_ID"));
            }

            set
            {
                GetDbObject().SetFieldValue("PACKAGE_FNLDISC_ID", value);
            }
        }
