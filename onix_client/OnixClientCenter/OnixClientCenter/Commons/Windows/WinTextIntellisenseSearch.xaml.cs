...
{
    public partial class WinTextIntellisenseSearch : Window
    {
        ...
        private UTextBoxSearch parentCaller = null;
        private MVBase extraParam = null;
        ...
        private void getFilterTextFromServer(String key, String text)
        {
            ...
            else
            {
                ...
                arr = OnixWebServiceAPI.GetListAPI("GetSearchTextList", "SEARCH_TEXT_LIST", t);
            }
