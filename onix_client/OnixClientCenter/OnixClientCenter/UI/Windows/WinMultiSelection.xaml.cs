...
{
    public partial class WinMultiSelection : Window
    {
        ...
        public WinMultiSelection(CCriteriaBase cr, String ction)
        {
            criteria = cr;
        ...
        private ArrayList getSelectedObject()
        {
            ArrayList arr = new ArrayList();

            foreach (MBaseModel o in itemSources)
            {
        ...
        private void updateSelectedFlag(Boolean selected)
        {
            if (itemSources == null)
            {
                return;
