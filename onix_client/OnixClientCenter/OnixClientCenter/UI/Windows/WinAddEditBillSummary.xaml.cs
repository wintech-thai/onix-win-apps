...
{
    public partial class WinAddEditBillSummary : Window
    {
        ...
        public WinAddEditBillSummary(String md, AccountDocumentType docType, ObservableCollection<MBaseModel> pItems, MAccountDoc actView)
        {   
            dt = docType;
        ...
        public String EntityNameCaption
        {
            get
            {
                String caption = CLanguage.getValue("customer_name");
        ...
        {
            if (!CHelper.VerifyAccessRight("SALE_BILLSUM_EDIT"))
            {
                return (false);
            }
