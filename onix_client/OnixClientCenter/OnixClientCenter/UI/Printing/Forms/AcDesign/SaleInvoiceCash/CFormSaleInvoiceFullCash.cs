...
{
    public class CFormSaleInvoiceFullCash : CBaseReport
    {
        public CFormSaleInvoiceFullCash() : base()
        {
        }

        protected override UserControl createPageObject(Size s, int pageIdx, int pageCount, CReportPageParam param)
        {
            UFormSaleInvoiceFullCash page = new UFormSaleInvoiceFullCash(dataSource, pageIdx, pageCount, rptCfg, param);
