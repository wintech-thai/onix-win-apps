...
{
    public partial class UFormOtDetailsP2 : UFormBase
    {
        private MVOTDocument otDoc = null;

        public UFormOtDetailsP2(MBaseModel model, int page, int totalPage, MReportConfig cfg, CReportPageParam param)
        {
            dataSource = model;
            ...
            populateAllowanceGrid(otDoc);
            populateExpenseGrid(otDoc);
        }

        private void populateExpenseGrid(MVOTDocument otDoc)
        {
        ...
        private void populateAllowanceGrid(MVOTDocument otDoc)
        {
            ColumnDefinition gridCol1 = new ColumnDefinition();
            ColumnDefinition gridCol2 = new ColumnDefinition();
            ColumnDefinition gridCol3 = new ColumnDefinition();
