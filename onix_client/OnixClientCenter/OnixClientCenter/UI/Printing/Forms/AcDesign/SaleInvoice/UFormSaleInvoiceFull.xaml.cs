...
{    
    public partial class UFormSaleInvoiceFull : UFormBase
    {
        public UFormSaleInvoiceFull(MBaseModel model, int page, int totalPage, MReportConfig cfg, CReportPageParam param)
        {
            if (model == null)
            {
            ...
            primaryColumns.Add(new GridLength(4, GridUnitType.Star));
