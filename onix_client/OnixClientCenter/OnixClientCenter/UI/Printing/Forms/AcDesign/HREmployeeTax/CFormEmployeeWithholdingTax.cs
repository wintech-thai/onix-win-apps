...
{
    public class CFormEmployeeWithholdingTax : CBaseReport
    {
        public CFormEmployeeWithholdingTax() : base()
        {
        }
        ...
        {
            UFormEmployeeWithholdingTax page = new UFormEmployeeWithholdingTax(dataSource, pageIdx, pageIdx, pageCount, rptCfg, param);
