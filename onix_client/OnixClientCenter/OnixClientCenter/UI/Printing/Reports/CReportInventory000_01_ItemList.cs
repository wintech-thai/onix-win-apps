...
{
    public class CReportInventory000_01_ItemList : CBaseReport
    {
        private Hashtable rowdef = new Hashtable();
        private ArrayList projSums = new ArrayList();

        public CReportInventory000_01_ItemList() : base()
        {
        }
        ...
        private void configReport()
        {
            ...
            addConfig("L1", 10, "item_uom", HorizontalAlignment.Center, HorizontalAlignment.Left, HorizontalAlignment.Center, "UOM_NAME", "S", false);
            addConfig("L1", 10, "balance_quantity", HorizontalAlignment.Center, HorizontalAlignment.Right, HorizontalAlignment.Right, "END_QUANTITY", "S", false);
            addConfig("L1", 10, "amount", HorizontalAlignment.Center, HorizontalAlignment.Right, HorizontalAlignment.Right, "END_AMOUNT_AVG", "S", true);
            addConfig("L1", 10, "amount_per_unit", HorizontalAlignment.Center, HorizontalAlignment.Right, HorizontalAlignment.Right, "END_UNIT_PRICE_AVG", "S", false);
        }
        ...
        protected override ArrayList getRecordSet()
        {
            ...
            Parameter.SetFieldValue("CHUNK_FLAG", "N");
            arr = OnixWebServiceAPI.GetListAPI("GetInventoryItemList", "ITEM_LIST", Parameter);
