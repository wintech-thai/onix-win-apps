...
{
	class CReportInv004_01_InventoryImportExport : CBaseReport
	{
		private Hashtable rowdef = new Hashtable();
		private MemoryStream stream = new MemoryStream();

        private int defCol = 9;
        private double defHeightCol = 30;
        private double[] widths;
		private double totals = 0;

        public CReportInv004_01_InventoryImportExport() : base()
        {
            widths = new double[] { 5, 10, 13, 13, 10, 18, 9, 10, 10 };
        }
        ...
        protected override void createRowTemplates()
		{
			...
			CColumn c_8 = new CColumn(new Thickness(0.5, 0.5, 0.5, 0.5), new GridLength(widths[8], GridUnitType.Star));
			h.AddColumn(c_8);
