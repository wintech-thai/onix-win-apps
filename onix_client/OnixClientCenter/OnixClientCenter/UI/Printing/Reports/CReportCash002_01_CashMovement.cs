...
{
	public class CReportCash002_01_CashMovement : CBaseReport
	{
		private Hashtable rowdef = new Hashtable();
		private MemoryStream stream = new MemoryStream();
        private double[] widths4Col = new double[4] {18, 19, 36, 27 };
        private double[] widths7Col = new double[7] {7, 11, 19, 12, 12, 12, 27 };
		private double[] totals = new double[7] { 0, 0, 0, 0, 0, 0, 0 };
        private int rowNo = 0;
        String Account, H = "", D = "";
	
        public CReportCash002_01_CashMovement() : base()
        {
        }
        ...
        protected override void createRowTemplates()
        {
			...
			nm = "HEADER_LEVEL2";
			CRow h2 = new CRow(nm, 30, 7, defMargin);
            h2.SetFont(null, FontStyles.Normal, 0, FontWeights.Bold);
			rowdef[nm] = h2;

			CColumn c3_0 = new CColumn(new Thickness(0.5, 0.5, 0, 0.5), new GridLength(widths7Col[0], GridUnitType.Star));
            h2.AddColumn(c3_0);

			CColumn c3_1 = new CColumn(new Thickness(0.5, 0.5, 0, 0.5), new GridLength(widths7Col[1], GridUnitType.Star));
            h2.AddColumn(c3_1);

			CColumn c3_2 = new CColumn(new Thickness(0.5, 0.5, 0, 0.5), new GridLength(widths7Col[2], GridUnitType.Star));
            h2.AddColumn(c3_2);

			CColumn c3_3 = new CColumn(new Thickness(0.5, 0.5, 0, 0.5), new GridLength(widths7Col[3], GridUnitType.Star));
            h2.AddColumn(c3_3);

			CColumn c3_4 = new CColumn(new Thickness(0.5, 0.5, 0, 0.5), new GridLength(widths7Col[4], GridUnitType.Star));
            h2.AddColumn(c3_4);
            ...
            nm = "DATA_LEVEL2";
			CRow r0 = new CRow(nm, 30, 7, defMargin);
			r0.SetFont(null, FontStyles.Normal, 0, FontWeights.Bold);
			rowdef[nm] = r0;

			CColumn r0_c0 = new CColumn(new Thickness(0.5, 0, 0, 0.5), new GridLength(widths7Col[0], GridUnitType.Star));
			r0_c0.SetHorizontalAlignment(HorizontalAlignment.Center);
			r0.AddColumn(r0_c0);

			CColumn r0_c1_0 = new CColumn(new Thickness(0.5, 0, 0, 0.5), new GridLength(widths7Col[1], GridUnitType.Star));
			r0_c1_0.SetHorizontalAlignment(HorizontalAlignment.Center);
			r0.AddColumn(r0_c1_0);

			CColumn r0_c1_1 = new CColumn(new Thickness(0.5, 0, 0, 0.5), new GridLength(widths7Col[2], GridUnitType.Star));
			r0_c1_1.SetHorizontalAlignment(HorizontalAlignment.Center);
			r0.AddColumn(r0_c1_1);

			CColumn r0_c2 = new CColumn(new Thickness(0.5, 0, 0, 0.5), new GridLength(widths7Col[3], GridUnitType.Star));
			r0_c2.SetHorizontalAlignment(HorizontalAlignment.Right);
			r0.AddColumn(r0_c2);

			CColumn r0_c3 = new CColumn(new Thickness(0.5, 0, 0, 0.5), new GridLength(widths7Col[4], GridUnitType.Star));
			...
			nm = "DATA_LEVEL3";
			CRow r2 = new CRow(nm, 30, 7, defMargin);
			r2.SetFont(null, FontStyles.Normal, 0, FontWeights.Normal);
			rowdef[nm] = r2;

			CColumn r2_c0 = new CColumn(new Thickness(0.5, 0, 0, 0.5), new GridLength(widths7Col[0], GridUnitType.Star));
			r2_c0.SetHorizontalAlignment(HorizontalAlignment.Center);
			r2.AddColumn(r2_c0);

			CColumn r2_c1_0 = new CColumn(new Thickness(0.5, 0, 0, 0.5), new GridLength(widths7Col[1], GridUnitType.Star));
			r2_c1_0.SetHorizontalAlignment(HorizontalAlignment.Center);
			r2.AddColumn(r2_c1_0);

			CColumn r2_c1_1 = new CColumn(new Thickness(0.5, 0, 0, 0.5), new GridLength(widths7Col[2], GridUnitType.Star));
			r2_c1_1.SetHorizontalAlignment(HorizontalAlignment.Left);
			r2.AddColumn(r2_c1_1);

			CColumn r2_c2 = new CColumn(new Thickness(0.5, 0, 0, 0.5), new GridLength(widths7Col[3], GridUnitType.Star));
			r2_c2.SetHorizontalAlignment(HorizontalAlignment.Right);
			r2.AddColumn(r2_c2);

			CColumn r2_c3 = new CColumn(new Thickness(0.5, 0, 0, 0.5), new GridLength(widths7Col[4], GridUnitType.Star));
			...
			nm = "FOOTER_LEVEL1";
			CRow f1 = new CRow(nm, 30, 7, defMargin);
			f1.SetFont(null, FontStyles.Normal, 0, FontWeights.Bold);
			rowdef[nm] = f1;

			CColumn fc_0 = new CColumn(new Thickness(0.5, 0, 0, 0.5), new GridLength(widths7Col[0], GridUnitType.Star));
            f1.AddColumn(fc_0);

			CColumn fc_1 = new CColumn(new Thickness(0.5, 0, 0, 0.5), new GridLength(widths7Col[1], GridUnitType.Star));
			f1.AddColumn(fc_1);

			CColumn fc_2 = new CColumn(new Thickness(0.5, 0, 0, 0.5), new GridLength(widths7Col[2], GridUnitType.Star));
			f1.AddColumn(fc_2);

			CColumn fc_3 = new CColumn(new Thickness(0.5, 0, 0, 0.5), new GridLength(widths7Col[3], GridUnitType.Star));
			fc_3.SetHorizontalAlignment(HorizontalAlignment.Right);
			f1.AddColumn(fc_3);

			CColumn fc_4 = new CColumn(new Thickness(0.5, 0, 0, 0.5), new GridLength(widths7Col[4], GridUnitType.Star));
		...
		public override CReportDataProcessingProperty DataToProcessingProperty(CTable o, ArrayList rows, int row)
		{
			...
			if (!H.Equals(D))
			{
                ...
                nr1.FillColumnsText("",
                    ...
                    "","","",
                    CUtil.FormatNumber(v.BeginAmountFmt, "-"),
                    "");
            ...
            if (newh > 0)
            {
                ...
                if (newh > 0)
                {
                    ...
                    nr2.FillColumnsText(
                        ...
                        v.DocumentDateFmt,
                        v.DocumentNo,
                        CUtil.FormatNumber(v.InAmountFmt, "-"),
                        CUtil.FormatNumber(v.OutAmountFmt, "-"),
                        CUtil.FormatNumber(v.EndAmountFmt, "-"), 
                        v.NoteTX);

                    totals[0] += CUtil.StringToDouble(v.InAmountFmt);
                    totals[1] += CUtil.StringToDouble(v.OutAmountFmt);
                    totals[2] = CUtil.StringToDouble(v.EndAmountFmt);
		...
		public override FixedDocument CreateFixedDocument()
		{
			...
			ArrayList arr = OnixWebServiceAPI.GetCashTransactionMovementList(Parameter);
