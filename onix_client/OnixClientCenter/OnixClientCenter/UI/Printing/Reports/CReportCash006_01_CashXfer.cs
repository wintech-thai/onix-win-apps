...
{
    public class CReportCash006_01_CashXfer : CBaseReport
    {
        private Hashtable rowdef = new Hashtable();
        private MemoryStream stream = new MemoryStream();

        private double[] widths = new double[8] { 5, 10, 10, 20, 20, 10, 10, 15 };
        private double[] totals = new double[8] { 0, 0, 0, 0, 0, 0, 0, 0};

        public CReportCash006_01_CashXfer() : base()
        {
        }
        ...
        private void createDataHeaderRow(UReportPage page)
        {
            ...
            r.FillColumnsText(
                ...
                CLanguage.getValue("FromAcc"),
                CLanguage.getValue("ToAcc"),
        ...
        public override ArrayList GetReportInputEntries()
        {
            ...
            entry = new CEntry("FromAcc", EntryType.ENTRY_TEXT_BOX, 300, true, "FROM_ACCOUNT_NO");
            entries.Add(entry);

            entry = new CEntry("ToAcc", EntryType.ENTRY_TEXT_BOX, 300, true, "TO_ACCOUNT_NO");
            entries.Add(entry);
