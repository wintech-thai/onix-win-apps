...
{
    public class CCriteriaReceiptItem : CCriteriaBase
    {
        ...
        public CCriteriaReceiptItem() : base(new MAccountDoc(new CTable("")), "CCriteriaReceiptItem")
        {
...
#region Criteria Configure
        ...
        private void createGridColumns()
        {
            ...
            {
                //AR Receipt
                CCriteriaColumnText c5 = new CCriteriaColumnText("colBillSummDoc", "bill_summary", "BillSummaryDocNo", 20, HorizontalAlignment.Left);
                AddGridColumn(c5);
                c5.Sortable = false;
            }
