...
{
    public partial class UProductSelection : UserControl
    {
        public static readonly DependencyProperty ProductSelectedProperty =
        DependencyProperty.Register("ProductSelected", typeof(MBaseModel), typeof(UProductSelection),
            new UIPropertyMetadata(null, new PropertyChangedCallback(OnProductSelectedChanged)));

        public event EventHandler OnChanged;

        public UProductSelection()
        {
            InitializeComponent();
        }
        ...
        {
            UProductSelection control = obj as UProductSelection;
            MPackageBonus d = (MPackageBonus)e.NewValue;
            updateGui(control, d);
        }
        ...
        private static void updateGui(UProductSelection control, MPackageBonus v)
        {
            if (v == null)
            {
                return;
            ...
            MPackageBonus o = new MPackageBonus(v.GetDbObject().Clone());
        ...
        {
            MPackageBonus v = (MPackageBonus)ProductSelected;
            if (v == null)
            {
                return;
            }
        ...
        {
            UProductSelection control = this;
